...
src/
  ...
  pages/          # Strony Astro i HTML
    ...
    montaz-klimatyzacji-mokotow.astro
    montaz-klimatyzacji-targowek.astro
    montaz-klimatyzacji-wesola.astro
    blog/
    ku-przestrodze/
...
## Przetwarzanie zdj�� klimatyzator�w Rotenso

### Wzorzec � Versu Mirror
| Parametr | Warto�� |
|---|---|
| Canvas | 1257 x 729 px |
| Klimatyzator szeroko�� | 1144 px |
| Klimatyzator wysoko�� | 384 px |
| Margines lewy | 53 px |
| Margines prawy | 59 px |
| Margines g�rny | 204 px |
| Margines dolny | 140 px |

### Kolejno�� krok�w (ImageMagick)
1. flatten - usu� kana� Alpha
2. trim - usu� bia�e t�o
3. resize 1144x384! - rozci�gnij do wymiar�w Mirror (! = wymu�)
4. geometry +53+204 - umie�� na canvas 1257x729

### Zasady
- Mo�na rozci�ga� klimatyzator pionowo i poziomo
- Bia�e t�o rozci�gaj r�wnomiernie ze wszystkich stron
- Rozmiar mo�e r�ni� si� od wzorca max 1%
- NIGDY nie przycinaj klimatyzatora
- Zawsze mierz w rz�dzie 300 (nie 250)
- Zawsze por�wnaj wszystkie 6 parametr�w z Versu Mirror przed outputem
